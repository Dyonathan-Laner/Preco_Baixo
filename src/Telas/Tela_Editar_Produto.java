 ...
 * @author Dyonathan
 */
public class Tela_Editar_Produto extends javax.swing.JFrame {

    ProdutoServicos serviceProduct = new ProdutoServicos(new ProdutoDao());
    public Usuario usuario;
    public int Id;
    public Tela_Editar_Produto(Usuario user, int id){
        initComponents();
        usuario = user;
        Id = id;
        Preencher(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Editar_Produto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Editar_Produto().setVisible(true);
            }
        });
    }
...
public void Preencher(int id){
    ...
    Produto product = serviceProduct.getProdutoId(id);
    txt_nome.setText(product.getNome());
    txt_preco.setText(product.getPreco().toString());
    txt_quantidade.setText(Integer.toString(product.getQuantidade()));
    txt_validade.setText(product.getValidade());
...
public void Salvar(){
    ...
    txt_quantidade.getText().isEmpty() || txt_preco.getText().isEmpty()){
        ...
        product.setNome(txt_nome.getText());
        product.setId(Id);
        
        try{
        product.setValidade(txt_validade.getText());
        }catch(Exception ex){
            lbl_erro.setText("insira uma validade valida ex: dd/mm/aaaa");
        }
        try{
        product.setPreco(Double.parseDouble(txt_preco.getText().toString()));
        }catch(Exception ex){
            lbl_erro.setText("Preço inválido");
            product.setPreco(0.00);
        }
        try{
        product.setQuantidade(Integer.parseInt(txt_quantidade.getText()));
        }catch(Exception ex){
            lbl_erro.setText("Quantidade inválida!");
            product.setQuantidade(0);
        }
        
        if(ProdutoServicos.validarProduto(product) == null){
            if(serviceProduct.atualizarProduto(product)){
            ...
            dispose();
                ...
                lbl_erro.setText("Erro ao atualizar Produto");
            }
        }else{
            lbl_erro.setText(ProdutoServicos.validarProduto(product));
        }
    }
}
